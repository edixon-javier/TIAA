...
const data = [
  ...
  },
  {
    ...
    desc: "Description",
    externalUrl:
      "https://demos.tiaa.org/invision/savi",
  },
  {
    thumbSrc: "placeholder.svg",
    title: "Title",
    desc: "Description",
    externalUrl:
      "https://tiaa.invisionapp.com/console/share/94PY2S38C6Z",
  },
];
...
addEventListener("click", (event) => {
  ...
  const iframUrl = document.getElementById("iframe");
  if (
